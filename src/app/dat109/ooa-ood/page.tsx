    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-[var(--muted)] max-w-2xl">
          SOLID-prinsippene og GRASP-mønstrene — gjenkjenn dem i kode og
          UML-diagrammer. Fra 2023 er dette flervalg på eksamen.
        </p>
      </div>
      ...
      <div className="rounded-xl border-2 border-dashed border-sysdev-300 dark:border-sysdev-700 p-12 text-center">
        ...
        <p className="text-sm text-[var(--muted)] max-w-md mx-auto">
          Her kommer teori og flervalgsdrilling for SOLID (SRP, OCP, LSP, ISP,
          DIP) og GRASP (Informasjonsekspert, Skaper, Lav kobling, Høy
          samhørighet, Kontroller, Polymorfi, Pure Fabrication, Indireksjon,
