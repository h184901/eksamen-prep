    ...
    <div>
      <div className="rounded-xl border-2 border-dashed border-network-300 dark:border-network-700 p-12 text-center">
        ...
        <p className="text-sm text-[var(--muted)] max-w-md mx-auto">
          Her vil du finne TCP-segmentformatet med alle felt, beregning av
          sekvensnummer og ACK, vindustørrelser for flytkontroll og
          AIMD-reglene for metningskontroll med formler.
        </p>
      </div>
    </div>
  );
