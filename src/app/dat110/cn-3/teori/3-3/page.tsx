  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="flex items-center gap-2 text-sm text-[var(--muted)]">
        ...
        <span>/</span>
        <span className="text-[var(--foreground)] font-medium">3.3 Pålitelig dataoverføring</span>
      </div>
        ...
        <Card color="network">
          ...
          <div className="grid sm:grid-cols-2 gap-2 mt-3">
            {[
              ...
              { problem: "Overtaking", icon: "O", desc: "Pakker kan komme i feil rekkefølge (ulike ruter)" },
        ...
        {activeRdt === "rdt1" && (
          <div className="space-y-3">
            <Card color="green">
              ...
              <p className="text-sm"><strong>Antakelse:</strong> Den underliggende kanalen er helt pålitelig — ingen bitfeil, ingen pakketap.</p>
              <p className="text-sm mt-2"><strong>Løsning:</strong> Sender sender pakker, mottaker mottar pakker. Ingen spesiell håndtering nødvendig.</p>
            </Card>
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <svg viewBox="0 0 200 100" className="w-full border border-[var(--card-border)] rounded-lg bg-white dark:bg-neutral-900 p-2">
                  ...
                  <text x="100" y="52" textAnchor="middle" fontSize="9" fill="#0e7490" fontWeight="bold">Vent på</text>
        ...
        {activeRdt === "rdt2" && (
          <div className="space-y-3">
            <Card color="blue">
              ...
              <p className="text-sm"><strong>Antakelse:</strong> Kanalen kan introdusere bitfeil, men pakker kan ikke gå tapt.</p>
              ...
              <ul className="list-disc list-inside text-sm text-[var(--muted)] space-y-1 mt-1">
                ...
                <li><strong>NAK</strong> (negative acknowledgement) — "pakken hadde feil, send på nytt"</li>
              </ul>
            </Card>
            <Card color="red">
                ...
                <div className="grid sm:grid-cols-2 gap-2 text-xs">
                  <div className="rounded bg-white/60 dark:bg-neutral-900/40 p-2">
                    ...
                    <ul className="list-disc list-inside text-[var(--muted)] mt-1 space-y-0.5">
                      ...
                      <li>Sender på nytt hvis NAK eller korrupt ACK/NAK</li>
                    </ul>
                  </div>
                  <div className="rounded bg-white/60 dark:bg-neutral-900/40 p-2">
          ...
          <div className="space-y-3">
            <Card color="network">
              ...
              <div className="rounded-lg bg-cyan-100 dark:bg-cyan-900/30 p-2 mt-2 text-xs">
                <strong>Eksempel:</strong> Sender venter på ACK for pakke 0. Mottar ACK 1 (dvs. mottaker sist fikk pakke 1 korrekt) → duplikat ACK → send pakke 0 på nytt. Dette er konseptuelt likt det TCP bruker!
              </div>
            </Card>
          </div>
        )}
        ...
        {activeRdt === "rdt3" && (
          <div className="space-y-3">
            <Card color="red">
              ...
              <p className="text-sm"><strong>Ny antakelse:</strong> Pakker kan også gå <em>tapt</em> (ikke bare korrupt).</p>
            ...
            <div className="space-y-3">
              ...
              {[
                ...
                { scenario: "ACK-tap", desc: "Pakken ankommer korrekt, men ACK forsvinner. Sender timer ut og retransmitterer. Mottaker mottar duplikat med seqnum 0 → kaster det, sender ACK på nytt.", color: "border-orange-400 bg-orange-50 dark:bg-orange-950/20" },
          ...
          <table className="w-full text-xs rounded-lg overflow-hidden border border-[var(--card-border)]">
            <thead className="bg-neutral-100 dark:bg-neutral-800">
              <tr>
                ...
                <th className="px-2 py-2 text-left">Gjenværende problem</th>
              </tr>
            </thead>
            <tbody>
              {[
      ...
      <Section title="3. Go-Back-N (GBN) og Selective Repeat (SR)" defaultOpen={true}>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <Card color="blue">
            ...
            <ul className="text-sm text-[var(--muted)] space-y-1 list-disc list-inside">
              ...
              <li>Timer per vindu (starter på eldste ukvitterte pakke)</li>
              <li>Ved timeout: <strong>send pakke n og ALLE etterfølgere på nytt</strong></li>
            ...
            <div className="mt-2 rounded bg-blue-100 dark:bg-blue-900/30 p-2 text-xs">
              <strong>Fordel:</strong> Enkelt mottaker (ingen buffering). <strong>Ulempe:</strong> Wasteful — sender mange pakker på nytt ved ett tap.
            </div>
          </Card>
          ...
          <Card color="purple">
            ...
            <ul className="text-sm text-[var(--muted)] space-y-1 list-disc list-inside">
              ...
              <li>Ved timeout: send KUN den tapte pakken på nytt</li>
            ...
            <div className="mt-2 rounded bg-purple-100 dark:bg-purple-900/30 p-2 text-xs">
              <strong>Fordel:</strong> Sender KUN manglende pakker på nytt. <strong>Ulempe:</strong> Kompleks buffering på mottakersiden.
            </div>
          </Card>
        </div>
        ...
        <div className="rounded-xl border border-[var(--card-border)] bg-[var(--card)] p-4">
          <h4 className="font-bold text-sm mb-3">Vindusstørrelse og sekvensnummer-krav</h4>
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              <div className="text-xs space-y-1">
                ...
                <p className="font-bold">Max vindusstørrelse for GBN: <span className="text-blue-600 dark:text-blue-400">2^k - 1</span></p>
            ...
            <div>
              ...
              <div className="text-xs space-y-1">
                <p>Med k-bit sekvensnummer: 2^k mulige verdier</p>
                <p className="font-bold">Max vindusstørrelse for SR: <span className="text-purple-600 dark:text-purple-400">2^k / 2 = 2^(k-1)</span></p>
          ...
          <table className="w-full text-sm rounded-lg overflow-hidden border border-[var(--card-border)]">
            ...
            <tbody>
              {[
                ...
                ["Max vindusstørrelse (k-bit seqnum)", "2^k - 1", "2^(k-1)"],
        ...
        <Card color="red">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="rounded-lg bg-white/60 dark:bg-neutral-900/40 p-2">
              ...
              <p className="text-xs text-[var(--muted)] mt-1">TCP-segmentet innkapsles i et IP-datagram, som igjen innkapsles i en Ethernet-ramme (eller annen link-layer ramme) ved overføring.</p>
            </div>
          </div>
        </Card>
      </Section>
