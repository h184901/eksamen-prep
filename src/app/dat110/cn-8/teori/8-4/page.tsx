  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-2 text-sm text-[var(--muted)]">
        ...
        <span>/</span>
        <span className="text-[var(--foreground)]">8.4 Autentisering</span>
      </div>

      <h1 className="text-2xl font-bold">8.4 Autentisering</h1>
      <p className="text-[var(--muted)] max-w-2xl">
        Autentiseringsprotokoller: nonce-baserte tilnærminger for å bekrefte identitet og forhindre replay-angrep.
      </p>
      ...
      <div className="rounded-xl border-2 border-dashed border-[var(--card-border)] p-12 text-center">
        ...
        <p className="text-sm text-[var(--muted)] max-w-md mx-auto">
          Her vil du finne grundig teori om autentiseringsprotokoller og nonce.
        </p>
      </div>
