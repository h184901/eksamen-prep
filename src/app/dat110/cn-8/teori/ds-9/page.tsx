  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-2 text-sm text-[var(--muted)]">
        ...
        <span>/</span>
        <span className="text-[var(--foreground)]">DS 9 Sikkerhet i distribuerte systemer</span>
      </div>

      <h1 className="text-2xl font-bold">DS 9 Sikkerhet i distribuerte systemer</h1>
      <p className="text-[var(--muted)] max-w-2xl">
        Sikkerhetstiltak spesifikke for distribuerte systemer: sikre kanaler, tilgangskontroll og nøkkelstyring.
      </p>
      ...
      <div className="rounded-xl border-2 border-dashed border-[var(--card-border)] p-12 text-center">
        ...
        <p className="text-sm text-[var(--muted)] max-w-md mx-auto">
          Her vil du finne grundig teori om sikre kanaler og tilgangskontroll i distribuerte systemer.
        </p>
      </div>
