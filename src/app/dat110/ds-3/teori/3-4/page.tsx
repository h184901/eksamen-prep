  ...
  return (
    <div className="space-y-8">
      ...
      <p className="text-[var(--muted)] max-w-2xl">
        Server-arkitekturvalg: iterativ vs concurrent, stateful vs stateless og håndtering av mange samtidige klienter.
      </p>
      ...
      <div className="rounded-xl border-2 border-dashed border-[var(--card-border)] p-12 text-center">
        ...
        <p className="text-sm text-[var(--muted)] max-w-md mx-auto">
          Her vil du finne grundig teori om server-design, iterativ vs concurrent og stateful vs stateless.
        </p>
      </div>
      ...
      <div className="flex justify-between items-center pt-6 border-t border-[var(--card-border)]">
        ...
        <Link href="/dat110/ds-3/teori/3-5" className="hover:text-[var(--accent)] text-sm">
          3.5 Kode-migrasjon →
        </Link>
      </div>
    </div>
