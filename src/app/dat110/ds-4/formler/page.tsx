  ...
  return (
    <div>
      ...
      <p className="text-[var(--muted)] mb-6 text-sm">
        DS Kapittel 4 — Viktige formlar, begrep og «når bruker du hva»-guide
      </p>
      ...
      <section className="mb-8">
        ...
        <div className="rounded-xl border-2 border-yellow-400 bg-yellow-50 dark:bg-yellow-950/20 p-5 mb-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <h4 className="font-semibold mb-2">Hvordan beregne:</h4>
              <ol className="space-y-1 text-[var(--muted)] list-decimal list-inside text-xs">
                ...
                <li>Summer alle fysiske lenkje-forsinkelser langs overlay-stigen</li>
        ...
        <div className="rounded-xl border border-[var(--card-border)] bg-[var(--card)] p-5">
          <h4 className="font-semibold mb-3">Rekneeksempel (fra forelesningen)</h4>
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-4">
          <div className="rounded-xl border-2 border-red-300 dark:border-red-700 bg-[var(--card)] p-4">
            ...
            <div className="bg-red-50 dark:bg-red-950/20 rounded-lg p-3 text-center mb-3">
              <p className="text-sm font-mono font-bold">S(l) = antall ganger lenkje l kryssast</p>
            </div>
            <p className="text-xs text-[var(--muted)]">
              Tell kor mange ganger en fysisk lenkje ⟨u,v⟩ kryssast av alle overlay-meldingane.
          ...
          <div className="rounded-xl border-2 border-green-300 dark:border-green-700 bg-[var(--card)] p-4">
            ...
            <div className="bg-green-50 dark:bg-green-950/20 rounded-lg p-3 text-center mb-3">
              <p className="text-sm font-mono font-bold">C(T) = sum av alle lenkje-kostnader i T</p>
            </div>
            <p className="text-xs text-[var(--muted)]">
              Globalt mål for heile treet. Summen av alle forsinkingane i spanntreet.
              Målet: minimum spenntre (MST).
            </p>
          </div>
        </div>

        <div className="rounded-xl border border-[var(--card-border)] bg-[var(--card)] p-5">
          <h4 className="font-semibold mb-3">Tree Cost — Rekneeksempel (fra forelesningen)</h4>
          <p className="text-xs text-[var(--muted)] mb-3">
            Overlay-nettverk med 5 prosesser A, B, C, D, E og kantane:
      ...
      <section className="mb-8">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-4">
          <div className="rounded-xl border-2 border-blue-300 dark:border-blue-700 bg-[var(--card)] p-5">
            ...
            <div className="space-y-3">
              <div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-3 text-center">
                ...
                <p className="text-xs text-[var(--muted)] mt-1">(optimalt — hver node besøkt én gang)</p>
              </div>
          ...
          <div className="rounded-xl border-2 border-purple-300 dark:border-purple-700 bg-[var(--card)] p-5">
            ...
            <p className="text-xs text-[var(--muted)]">
              <strong>p_edge</strong> = sannsynlighet for at to noder er knytt saman.
              Høgare p_edge = fleire kantar = fleire meldinger = dyrare.
            </p>
          </div>
        </div>

        <div className="rounded-xl border border-[var(--card-border)] bg-[var(--card)] p-5">
          <h4 className="font-semibold mb-3">Rekneeksempel (fra øvingsoppgave)</h4>
          <div className="grid sm:grid-cols-2 gap-4 text-sm">
            <div className="bg-gray-50 dark:bg-gray-900/30 rounded p-3">
              ...
              <div className="font-mono text-xs text-[var(--muted)] space-y-1">
                ...
                <p>M = ½ · 100000 · 99999 · 0.2</p>
                <p className="text-green-600 font-bold">M ≈ 999 990 000 meldinger</p>
              </div>
            </div>
            <div className="bg-gray-50 dark:bg-gray-900/30 rounded p-3">
          ...
          <table className="w-full text-sm border-collapse rounded-xl overflow-hidden">
            ...
            <tbody>
              <tr className="border-b border-[var(--card-border)] bg-[var(--card)]">
                ...
                <td className="px-4 py-3 text-[var(--muted)]">At-most-once (maks én gang)</td>
              ...
              <tr className="border-b border-[var(--card-border)] bg-[var(--card)]">
                ...
                <td className="px-4 py-3 text-[var(--muted)]">At-least-once (minst én gang)</td>
                ...
                <td className="px-4 py-3 text-[var(--muted)]">Dørsensor, kritisk tilstand</td>
              </tr>
              <tr className="bg-[var(--card)]">
                ...
                <td className="px-4 py-3 text-[var(--muted)]">Exactly-once (nøyaktig én gang)</td>
      ...
      <section className="mb-8">
          ...
          {[
            {
              ...
              forklaring: "Mottakeleg nabo (S) tar kontakt med tilfeldig nabo. Effektivt seint i prosessen.",
            },
            {
              model: "Push",
        ...
        <div className="mt-4 rounded-xl border border-[var(--card-border)] bg-[var(--card)] p-5">
          <h4 className="font-semibold mb-3">Rekneeksempel (fra professorens øvingsoppgave)</h4>
          <p className="text-xs text-[var(--muted)] mb-3">
            Distribuert system med 1000 noder. Runde i: Infiserte = 400, Mottagelige = 600, Fjernet = 0.
          ...
          <div className="grid sm:grid-cols-3 gap-3 text-xs font-mono">
            <div className="bg-blue-50 dark:bg-blue-950/20 rounded p-3">
              ...
              <p className="text-[var(--muted)]">16% forblir mottagelig</p>
            </div>
            ...
            <div className="bg-purple-50 dark:bg-purple-950/20 rounded p-3">
              ...
              <p className="text-[var(--muted)]">Bare 3.5% forblir mottagelig!</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-amber-100 dark:bg-amber-900/30">
                  ...
                  <th className="border border-amber-300 px-3 py-2 text-left">Hvorfor</th>
                </tr>
              </thead>
              <tbody>
                {[
                  { situation: "Finn overlay-forsinkelse mellom to noder", bruk: "Sum alle lenkjeforsinkelsar langs overlay-stigen", hvorfor: "Følg overlay-kantane, ikke kortaste fysiske sti" },
                  { situation: "Samanlikn overlay vs fysisk sti", bruk: "RDP = D_overlay / D_nett", hvorfor: "RDP < 1 er umulig, RDP = 1 er perfekt" },
                  { situation: "Finn beste spenntre for overlay", bruk: "Kruskal / Prim MST-algoritme", hvorfor: "Minimér sum av alle kantforsinkelsar" },
                  { situation: "IoT-sensor, tap er ok", bruk: "MQTT QoS 0", hvorfor: "Lavast overhead, data kommer inn kontinuerleg" },
                  { situation: "Kritisk tilstand-endring", bruk: "MQTT QoS 1", hvorfor: "Meldinga kommer fram, applikasjon forkastes duplikat via ID" },
                  { situation: "Finansiell transaksjon / alarm", bruk: "MQTT QoS 2", hvorfor: "Nøyaktig én gang — duplikat kan gi feil handling" },
                  { situation: "Kan ikke skille krasja fra tapt svar", bruk: "RPC-feilklasse 3 eller 4", hvorfor: "At-least-once vs at-most-once semantikk — bruk idempotente kall" },
                ].map((row, i) => (
                  <tr key={i} className={i % 2 === 0 ? "bg-amber-50/50 dark:bg-amber-950/10" : "bg-white dark:bg-gray-900"}>
                    ...
                    <td className="border border-amber-200 dark:border-amber-800 px-3 py-2 text-[var(--muted)] text-xs">{row.hvorfor}</td>
                  </tr>
                ))}
              </tbody>
            </table>
