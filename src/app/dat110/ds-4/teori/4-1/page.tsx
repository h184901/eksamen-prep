  ...
  return (
    <div className="space-y-8">
      ...
      <p className="text-[var(--muted)] max-w-2xl">
        Grunnleggende kommunikasjonsmønstre: persistent vs transient og synkron vs asynkron kommunikasjon.
      </p>
      ...
      <div className="rounded-xl border-2 border-dashed border-[var(--card-border)] p-12 text-center">
        ...
        <p className="text-sm text-[var(--muted)] max-w-md mx-auto">
          Her vil du finne grundig teori om persistent/transient og synkron/asynkron kommunikasjon.
        </p>
      </div>
