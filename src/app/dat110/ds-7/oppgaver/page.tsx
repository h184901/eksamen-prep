...
export default function DS7OppgaverPage() {
  return (
    <div>
      <div className="rounded-xl border-2 border-dashed border-network-300 dark:border-network-700 p-12 text-center">
        ...
        <p className="text-sm text-[var(--muted)] max-w-md mx-auto">
          Her kommer oppgaver om konsistensmodeller, quorum-beregning,
          klient-sentrerte garantier og eksamensoppgaver fra Oppg 9.
        </p>
      </div>
    </div>
  );
