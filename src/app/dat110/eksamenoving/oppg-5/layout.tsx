...
export default function Oppg5Layout({ children }: { children: React.ReactNode }) {
  return (
    <div>
      ...
      <p className="text-[var(--muted)] max-w-2xl mb-6">CIDR-adressering, avstandsvektoralgoritme og forwardingtabeller.</p>

      <OppgaveSubNav basePath="/dat110/eksamenoving/oppg-5" />
      {children}
    </div>
  );
}
