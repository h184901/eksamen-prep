...
export default function Oppg8Layout({ children }: { children: React.ReactNode }) {
  return (
    <div>
      ...
      <p className="text-[var(--muted)] max-w-2xl mb-6">Overlay-nettverk, RDP-beregning og multicast-trær.</p>

      <OppgaveSubNav basePath="/dat110/eksamenoving/oppg-8" />
      {children}
    </div>
  );
}
