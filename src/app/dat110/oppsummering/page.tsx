      ...
      <div className="space-y-4">
        ...
        <RefCard title="3. UDP vs TCP (Oppg 3-4)" color="network">
          <MiniTable
            ...
            rows={[
              ...
              ["Pålitelig", "Nei", "Ja (sekvensnr, ACK, retransmisjon)"],
              ["Rekkefølge", "Nei", "Ja"],
        ...
        <RefCard title="5. Switch og ARP (Oppg 5-6)" color="blue">
          ...
          <ol className="text-xs text-[var(--muted)] list-decimal list-inside space-y-1">
            ...
            <li>Slå opp destinasjons-MAC i tabellen</li>
            <li>Hvis funnet: send ut på den porten (unntatt inngangsport)</li>
            <li>Hvis IKKE funnet: flood (send ut på ALLE porter unntatt inngangsport)</li>
          </ol>
          <p className="text-xs text-[var(--muted)] mt-2">Switch vs Ruter: Switch = lag 2 (MAC-adresser, lærer automatisk). Ruter = lag 3 (IP-adresser, rutingprotokoller).</p>
        </RefCard>
        ...
        <RefCard title="6. RPC, MQTT og overlay (Oppg 7-8)" color="purple">
          ...
          />
          <Formula>RDP = overlay-stiforsinkelse / beste fysiske stiforsinkelse (nær 1.0 = effektivt)</Formula>
        </RefCard>
        ...
        <RefCard title="7. Klokker og koordinering (Oppg 9)" color="amber">
          ...
          <p className="text-xs text-[var(--muted)]">Bully: høyeste ID vinner. Ring: send ID rundt, høyeste vinner. Begge O(n^2) meldinger i verste fall.</p>
        </RefCard>
        ...
        <div className="rounded-xl border-2 border-green-400/40 bg-green-50 dark:bg-green-950/20 p-6 mt-6">
          ...
          <div className="grid sm:grid-cols-2 gap-3 text-sm">
            {[
              ...
              "Kan du bygge fingertabell, bestemme nøkkelansvar og gjøre oppslag?",
