...
const sections = [
  {
    id: "21.3",
    title: "Coulombs lov",
    exercises: ["21.6", "21.9", "21.13", "21.16", "21.17", "21.18", "21.19"],
  },
  {
    id: "21.4",
    title: "Elektrisk felt og elektriske krefter",
    exercises: ["21.22", "21.24", "21.25", "21.27", "21.29", "21.30"],
  },
  {
    id: "21.6",
    title: "Elektriske feltlinjer",
    exercises: [],
  },
  {
    id: "problems",
    title: "Problems",
    exercises: ["21.59", "21.60", "21.61", "21.88"],
  },
  {
    id: "challenge",
...
export default function Kapittel21OppgaverPage() {
    ...
    <div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm text-[var(--muted)] mb-4">
          ...
          <span>/</span>
          <span className="text-[var(--foreground)]">Kapittel 21</span>
        </div>
        <h1 className="text-3xl font-bold mb-2">Kapittel 21 — Elektrisk ladning og felt</h1>
        <p className="text-[var(--muted)] max-w-2xl">
          Utvalgte oppgaver fra University Physics sortert etter delkapittel. Velg en seksjon og deretter en oppgave.
        </p>
        <Link href="/ing164/kapittel-21/teori" className="inline-flex items-center gap-1.5 mt-3 text-sm text-[var(--accent)] hover:underline">
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" /></svg>
          Les teori for kapittel 21
        </Link>
      </div>
