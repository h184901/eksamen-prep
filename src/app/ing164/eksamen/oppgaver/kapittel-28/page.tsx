...
const sections = [
  {
    id: "28.1",
    title: "Magnetfelt fra en bevegelig ladning",
    exercises: ["28.1", "28.5", "28.6"],
  },
  {
    id: "28.2",
    title: "Magnetfelt fra en strømførende leder",
    exercises: ["28.11"],
  },
  {
    id: "28.3",
    title: "Magnetfelt fra en spole",
    exercises: ["28.19", "28.20", "28.21"],
  },
  {
    id: "28.4",
    title: "Amperes lov",
    exercises: ["28.27", "28.29", "28.30"],
  },
  {
    id: "problems",
    title: "Problems",
...
export default function Kapittel28OppgaverPage() {
    ...
    <div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm text-[var(--muted)] mb-4">
          ...
          <span>/</span>
          <span className="text-[var(--foreground)]">Kapittel 28</span>
        </div>
        <h1 className="text-3xl font-bold mb-2">Kapittel 28 — Kilder til magnetfelt</h1>
        <p className="text-[var(--muted)] max-w-2xl">
          Utvalgte oppgaver fra University Physics sortert etter delkapittel. Velg en seksjon og deretter en oppgave.
        </p>
        <Link href="/ing164/kapittel-28/teori" className="inline-flex items-center gap-1.5 mt-3 text-sm text-[var(--accent)] hover:underline">
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" /></svg>
          Les teori for kapittel 28
        </Link>
      </div>
