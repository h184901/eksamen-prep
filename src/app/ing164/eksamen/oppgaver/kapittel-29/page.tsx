...
const sections = [
  { id: "29.2", title: "Faradays lov", exercises: ["29.1", "29.6", "29.8", "29.13"] },
  { id: "29.3", title: "Lenz' lov", exercises: ["29.15", "29.19", "29.22"] },
  { id: "29.4", title: "Induktans og selvinduktans", exercises: ["29.24", "29.25", "29.27"] },
  { id: "problems", title: "Problems", exercises: ["29.51", "29.59"] },
];
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-3 pb-3 border-b border-[var(--card-border)]">
        ...
        <span className={`text-xs font-semibold px-2 py-0.5 rounded-full border ${difficultyBadge[exercise.difficulty]}`}>
          {exercise.difficulty}
        </span>
...
export default function Kapittel29OppgaverPage() {
    ...
    <div>
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm text-[var(--muted)] mb-4">
          ...
          <span>/</span>
          <span className="text-[var(--foreground)]">Kapittel 29</span>
        </div>
        <h1 className="text-3xl font-bold mb-2">Kapittel 29 — Elektromagnetisk induksjon</h1>
        <p className="text-[var(--muted)] max-w-2xl">
          Utvalgte oppgaver fra University Physics sortert etter delkapittel. Velg en seksjon og deretter en oppgave.
        </p>
        <Link href="/ing164/kapittel-29/teori" className="inline-flex items-center gap-1.5 mt-3 text-sm text-[var(--accent)] hover:underline">
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" /></svg>
          Les teori for kapittel 29
        </Link>
      </div>
