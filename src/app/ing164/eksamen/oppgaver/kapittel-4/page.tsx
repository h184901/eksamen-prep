...
const sections = [
  { id: "4.1", title: "Kraft og vekselvirkninger", exercises: ["4.1", "4.2", "4.4", "4.5"] },
  { id: "4.2", title: "Newtons første lov", exercises: [] },
  { id: "4.3", title: "Newtons andre lov", exercises: ["4.6", "4.7", "4.9", "4.10", "4.12"] },
  { id: "4.4", title: "Masse og vekt", exercises: ["4.16", "4.17", "4.19"] },
  { id: "4.5", title: "Newtons tredje lov", exercises: ["4.21", "4.23", "4.25"] },
  { id: "4.6", title: "Frilegmediagram", exercises: ["4.26", "4.27", "4.30"] },
  { id: "problems", title: "Problems", exercises: ["4.32", "4.33", "4.35", "4.49", "4.52"] },
  { id: "challenge", title: "Challenge Problems", exercises: ["4.56"] },
];
...
export default function Kapittel4OppgaverPage() {
    ...
    <div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm text-[var(--muted)] mb-4">
          ...
          <span>/</span>
          <span className="text-[var(--foreground)]">Kapittel 4</span>
        </div>
        <h1 className="text-3xl font-bold mb-2">Kapittel 4 — Newtons lover</h1>
        <p className="text-[var(--muted)] max-w-2xl">
          Utvalgte oppgaver fra University Physics sortert etter delkapittel. Velg en seksjon og deretter en oppgave.
        </p>
        <Link href="/ing164/kapittel-4/teori" className="inline-flex items-center gap-1.5 mt-3 text-sm text-[var(--accent)] hover:underline">
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" /></svg>
          Les teori for kapittel 4
        </Link>
      </div>
