...
const sections = [
  {
    id: "9.1",
    title: "Vinkelstørrelser",
    exercises: ["9.1", "9.2", "9.4", "9.5"],
  },
  {
    id: "9.2",
    title: "Rotasjon med konstant vinkelakselerasjon",
    exercises: ["9.9", "9.14", "9.16"],
  },
  {
    id: "9.3",
    title: "Sammenheng mellom lineær og vinkelstørrelser",
    exercises: ["9.20", "9.21", "9.23", "9.25"],
  },
  {
    id: "9.4",
    title: "Rotasjonsenergi og treghetsmoment",
    exercises: ["9.30", "9.31", "9.33", "9.35", "9.45", "9.48"],
  },
  {
    id: "9.5",
    title: "Parallellaksesetningen",
    exercises: ["9.51"],
  },
  {
    id: "problems",
    title: "Problems",
    exercises: ["9.64", "9.77", "9.78", "9.79"],
  },
];
...
export default function Kapittel9OppgaverPage() {
    ...
    <div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm text-[var(--muted)] mb-4">
          ...
          <span>/</span>
          <span className="text-[var(--foreground)]">Kapittel 9</span>
        </div>
        <h1 className="text-3xl font-bold mb-2">Kapittel 9 — Rotasjon av stive legemer</h1>
        <p className="text-[var(--muted)] max-w-2xl">
          Utvalgte oppgaver fra University Physics sortert etter delkapittel. Velg en seksjon og deretter en oppgave.
        </p>
        <Link href="/ing164/kapittel-9/teori" className="inline-flex items-center gap-1.5 mt-3 text-sm text-[var(--accent)] hover:underline">
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" /></svg>
          Les teori for kapittel 9
        </Link>
      </div>
