  ...
  return (
    <div>
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        ...
        <Link href="/ing164/eksamen/oppgaver/kapittel-2" className="group rounded-xl border border-[var(--card-border)] bg-[var(--card)] p-5 hover:border-blue-400/50 hover:shadow-sm transition-all">
          <div className="flex items-center gap-2 mb-2">
