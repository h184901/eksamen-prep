...
// Consistent section rhythm for DAT110 pages: small eyebrow + H2 + optional
// description, then content. Gives the editorial/notebook feel and a single
// spacing scale across the page.
export default function Dat110Section({
  eyebrow,
  title,
  description,
  actions,
