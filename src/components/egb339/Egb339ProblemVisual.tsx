...
const line = "stroke-robotics-600 dark:stroke-robotics-300";
const accent = "stroke-amber-500 dark:stroke-amber-300";
const label = "fill-slate-700 text-[10px] font-semibold dark:fill-slate-200";
...
function StaticFrames() {
  return (
    <svg viewBox="0 0 420 190" role="img" aria-label="Referanserammene A, B og C">
      ...
      <circle cx="40" cy="150" r="5" className="fill-slate-700 dark:fill-slate-200" />
      <circle cx="195" cy="150" r="5" className="fill-robotics-600 dark:fill-robotics-300" />
      <circle cx="195" cy="45" r="5" className="fill-amber-500 dark:fill-amber-300" />
...
function Week4Arm() {
  return (
    <svg viewBox="0 0 420 190" role="img" aria-label="Plan kinematisk kjede med tre ledd">
      ...
      <circle cx="105" cy="158" r="11" className="fill-white stroke-robotics-600 dark:fill-slate-900 dark:stroke-robotics-300" strokeWidth="4" />
      <circle cx="205" cy="78" r="11" className="fill-white stroke-robotics-600 dark:fill-slate-900 dark:stroke-robotics-300" strokeWidth="4" />
      <circle cx="330" cy="52" r="8" className="fill-amber-500 dark:fill-amber-300" />
...
function TwoLinkArm() {
  return (
    <svg viewBox="0 0 420 190" role="img" aria-label="Plan robotarm med to rotasjonsledd">
      ...
      <circle cx="55" cy="160" r="11" className="fill-white stroke-robotics-600 dark:fill-slate-900 dark:stroke-robotics-300" strokeWidth="4" />
      <circle cx="190" cy="65" r="11" className="fill-white stroke-robotics-600 dark:fill-slate-900 dark:stroke-robotics-300" strokeWidth="4" />
      <circle cx="345" cy="105" r="8" className="fill-amber-500 dark:fill-amber-300" />
...
function MixedJointArm() {
  return (
    <svg viewBox="0 0 420 190" role="img" aria-label="Robot med prismatisk og roterende ledd">
      ...
      <rect x="143" y="79" width="44" height="24" rx="5" transform="rotate(-34 165 91)" className="fill-white stroke-robotics-600 dark:fill-slate-900 dark:stroke-robotics-300" strokeWidth="3" />
      <circle cx="210" cy="55" r="10" className="fill-white stroke-amber-500 dark:fill-slate-900 dark:stroke-amber-300" strokeWidth="4" />
      <circle cx="342" cy="96" r="8" className="fill-amber-500 dark:fill-amber-300" />
...
function MotionProfile() {
  return (
    <svg viewBox="0 0 420 190" role="img" aria-label="Stykkevis akselerasjonsprofil">
      ...
      <path d="M140 30V165M270 30V165" className="fill-none stroke-slate-300 dark:stroke-slate-700" strokeDasharray="5 5" />
...
function PointSegment() {
  return (
    <svg viewBox="0 0 420 190" role="img" aria-label="Korteste avstand fra punkt til linjesegment">
      ...
      <circle cx="55" cy="150" r="7" className="fill-robotics-600 dark:fill-robotics-300" />
      <circle cx="350" cy="40" r="7" className="fill-robotics-600 dark:fill-robotics-300" />
      <circle cx="215" cy="150" r="10" className="fill-amber-500 dark:fill-amber-300" />
      <path d="M215 150L177 104" className={`${accent} fill-none`} strokeWidth="3" strokeDasharray="6 5" />
      <path d="M170 107L180 113L185 101" className={`${accent} fill-none`} strokeWidth="2" />
      <text x="38" y="170" className={label}>A</text>
      <text x="357" y="38" className={label}>B</text>
      <text x="226" y="157" className={label}>O</text>
      <text x="188" y="124" className={label}>d</text>
      <text x="162" y="96" className={label}>C</text>
    </svg>
  );
}
  ...
  if (kind === "highway") {
    return (
      <div className="relative aspect-[4/3] overflow-hidden rounded-xl bg-slate-100 dark:bg-slate-900">
        <Image src="/egb339/week8/highway.jpg" alt="Highway-bildet brukt i uke 8-practicalen" fill sizes="(max-width: 768px) 100vw, 700px" className="object-cover" />
      </div>
    );
  }

  return (
    <div className="overflow-hidden rounded-xl border border-[var(--card-border)] bg-slate-50 p-2 dark:bg-slate-950/40">
