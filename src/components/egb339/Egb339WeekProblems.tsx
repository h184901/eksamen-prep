...
const verificationLabel: Record<Egb339Problem["verification"], string> = {
  ...
  corrected: "QUT-fasit med forklart rettelse",
...
const verificationTone: Record<Egb339Problem["verification"], string> = {
  ...
  corrected: "border-amber-300 bg-amber-50 text-amber-800 dark:border-amber-800 dark:bg-amber-950/40 dark:text-amber-200",
