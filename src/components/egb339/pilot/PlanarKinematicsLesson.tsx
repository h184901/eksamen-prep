...
function TrySolution({ mode, embedded, children }: { mode: "fk" | "ik"; embedded: boolean; children: React.ReactNode }) {
  if (embedded) return <WeekOneDisclosure id={`planar-${mode}-try-solution`} title="Kontroll av 2R-modellen">{children}</WeekOneDisclosure>;
  return <details className="egb-pilot-solution"><summary>Vis løsning og kontroll</summary>{children}</details>;
}
...
export default function PlanarKinematicsLesson({ mode, embedded = false }: { mode: "fk" | "ik"; embedded?: boolean }) {
  ...
  return <>
    <section className="egb-pilot-prose" id="planar-modell">
      <Heading>En plan 2R-modell</Heading>
    ...
    {mode === "fk" ? <section className="egb-pilot-prose" id="regneeksempel">
      <Heading>Regneeksempel: fra leddvinkler til (5, 7)</Heading>
      ...
      <Subheading>1. Bygg transformasjonen til albuen</Subheading>
      ...
      <Subheading>2. Bygg transformasjonen langs lenke 2</Subheading>
      ...
      <Subheading>3. Multipliser og les av posisjonen</Subheading>
      ...
      <Heading>Regneeksempel: to løsninger for (5, 7)</Heading>
      ...
      <Subheading>1. Kontroller rekkevidden</Subheading>
      ...
      <Subheading>2. Finn begge albuevinklene</Subheading>
      <MathText>{String.raw`c_2=\frac{25+49-25-49}{2\cdot5\cdot7}=0,\qquad q_2=\pm\arccos0=\pm\frac\pi2`}</MathText>
      <Subheading>3. Finn tilhørende skuldervinkel</Subheading>
      ...
      <Subheading>4. Sett begge løsningene tilbake i FK</Subheading>
    ...
    <section className="egb-pilot-prose" id="modell-assessment">
      <Heading>Fra 2R-modellen til kursoppgavene</Heading>
