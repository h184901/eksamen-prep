  ...
  return <div className="egb-week-figure-explanation">
    <figure className="egb-week-technical-figure">
      <svg viewBox="0 0 520 320" role="img" aria-labelledby="week4-chain-title week4-chain-description">
        <title id="week4-chain-title">{lang === "en" ? "QUT's RPR chain in its zero configuration" : "QUTs RPR-kjede i nullstillingen"}</title>
        <desc id="week4-chain-description">{lang === "en" ? "A fixed link of length 8 to the right, a prismatic link of length 5 plus q2 at 45 degrees, and a final link of length 4 to the right. q1 and q3 rotate at the two joints. Here all q are zero." : "En fast lenke på 8 mot høyre, en prismatisk lenke på 5 pluss q2 ved 45 grader, og en siste lenke på 4 mot høyre. q1 og q3 roterer ved de to knekkpunktene. Her er alle q null."}</desc>
      ...
      <figcaption>{lang === "en" ? "Original figure based on QUT," : "Egen figur etter QUT,"} <cite>Tutorial – Forward Kinematics (1)</cite>, {lang === "en" ? "p. 9. Link lengths and the 45° offset are preserved. This is not the lab's 2R arm." : "s. 9. Lengdeforhold og 45°-offset er beholdt. Dette er ikke 2R-armen i laben."}</figcaption>
    </figure>
