...
export interface Egb339WeekLearning { purpose: string; practical: string; sources: string[] }
export const EGB339_WEEK_LEARNING: Record<number, Egb339WeekLearning> = {
  ...
  4: {
    ...
    sources: ["QUT: Tutorial – Forward Kinematics (1), s. 2–9; Week 4 Prac: Forward kinematics (7. september 2026), s. 1–3.", "Corke: kap. 7.1.1, s. 257–259, særlig figur 7.4 og ETS2-kjeden. Boka bruker q₀/q₁ der QUT-laben bruker q₁/q₂.", "Robotics Toolbox: models/ETS/Planar2.py, ET2/ETS2 og DHRobot.fkine. Den eksisterende 2R-laben gjenbruker validerte transformasjoner."],
  },
  5: {
    purpose: "Finn leddvinkler fra et målpunkt. Skill mellom to løsninger, én grenseløsning og et mål som ikke kan nås.",
    practical: "Arbeid først med QUTs tolenkearm: L₁ = 5 og L₂ = 7. Last inn alle tre tutorialmål i IK-laben og kontroller begge grener med FK. Overfør deretter trekantmetoden til Dobots armplan og leddkonvensjon i Assessment 1.4; det er en annen robotmodell.",
  ...
  6: {
    ...
    practical: "Tutorialen bygger Jacobianen for hånd og med SymPy. Bruk q = (π/4, π/4), L₁ = 5 og L₂ = 7, og sammenlign den lokale posisjonsoppdateringen med full FK etter et tidssteg. De dokumenterte feilene i QUT-fasiten står ved oppgaven og er ikke kopiert inn i modellen.",
